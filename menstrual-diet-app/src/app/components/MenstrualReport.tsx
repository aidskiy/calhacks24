...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState([
    ...
    {
      sender: "AI",
      text: "Sorry, I couldn't find any information about that.",
    },
  ]);
  ...
  return (
    <>
      ...
      >
        ...
        >
          <path d="M3 21l1.9-5.7a8.5 8.5 0 113.8 3.8z" className="border-gray-200" />
        </svg>
      </button>
      ...
      {isOpen && (
        <div
          ...
          className="fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-gray-200 w-[440px] h-[634px]"
        >
          {/* Heading */}
          <div className="flex flex-col space-y-1.5 pb-6">
            <h2 className="font-semibold text-lg tracking-tight">Chatbot</h2>
            <p className="text-sm text-gray-600 leading-3">Powered by Mendable and Vercel</p>
          </div>
                  ...
                  <div className="rounded-full bg-gray-100 border p-1">
                    {message.sender === "AI" ? (
                      ...
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <path d="M8 8a3 3 0 100-6 3 3 0 000 6zm2-3a2 2 0 11-4 0 2 2 0 014 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664h10z" />
                      </svg>
                    )}
                  </div>
                </span>
